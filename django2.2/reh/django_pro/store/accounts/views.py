...
from .forms import (
    ...
    ResendActivationCodeForm, ResendActivationCodeViaEmailForm,  ChangeEmailForm,EditProfileForm,ProfileForm,
)
...
def payment_(request):
    if request.method=='POST':
        ...
        year=request.POST.get('yy')
        cvv=request.POST.get('cvv')
        payment.objects.create(fullname=full_name,card_no=card,month=month,year=year,cvv=cvv,order_id=int(request.session['order_id']))   
