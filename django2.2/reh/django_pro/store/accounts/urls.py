...
from .views import (
    ...
    ChangeEmailView, ChangeEmailActivateView, edit_profile, ChangePasswordView,
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView,payment_,blogsingle
)
...
urlpatterns = [
    ...
    path('payment/', payment_, name='payment'),
    path('accounts/blog-single/', blogsingle, name='blog-single'),
]
