...
# # value = random.uniform(1, 10)  # any number include decimal 9 digit
# # value = random.randint(1, 6)  # any number without decimal

# greetings = ['Hi', 'Hello', 'Hey', 'Hola', 'Howdy']
# # value = random.choice(greetings)  # random import from greeting

# #  To display 10 times random results like bunch selection
# # results = random.choices(greetings, weights=[18, 18, 2], k=10)
# # print(results)


# deck = list(range(1, 53))
# # random.shuffle(deck)
# hand = random.sample(deck, k=5)  # No repeatation
# print(hand)
...
for num in range(1, 11):
  ...
  email = first.lower() + last.lower() + '@bizzme.io'
  print("Sr no: ", num)
  print(f'{first} {last}\n{phone}\n{address}\n{email}\n')
